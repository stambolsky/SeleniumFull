...
public class CheckSortingOfCountriesAndGeoFencesInAdminPanel extends TestBase {
    ...
    public void checkSortGeoZones() throws InterruptedException {
        ...
        driver.findElement(By.name("password")).sendKeys("admin");
        driver.findElement(By.name("login")).click();
        List<WebElement> countries = driver.findElements(By.cssSelector("form .dataTable td:nth-child(3)>a"));
        ...
        for (String name : countriesList) {
            ...
            List<WebElement> zonesList = driver.findElements(By.xpath("//form//td[3]//option[@selected='selected']"));
            List<String> zonesSortList = new ArrayList<String>();
            List<String> zonesUnSortList = new ArrayList<String>();
